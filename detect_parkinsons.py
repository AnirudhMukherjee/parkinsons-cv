...
def load_split(path):
	...
	for imagePath in imagePaths:
		...
		print("Label:", imagePath.split(os.path.sep)[-2])
		print("OS path sep idk: ", os.path.sep)
...
print("Y train before label encode: ", trainY)
le = LabelEncoder()
trainY = le.fit_transform(trainY)
testY = le.transform(testY)
print("Y train after label encode: ", trainY)
trials = {}
